...
#### 1. Uvod
<p align="justify">Ova Politika privatnosti opisuje kako mobilna aplikacija Promet („aplikacija”) postupa s informacijama kada je koristite na Android uređaju. Promet je aplikacija za vođenje knjige prometa, praćenje računa i rashoda te pomoć pri administrativnim i poreznim obvezama obrtnika i poduzetnika u Hrvatskoj. Aplikacija ne prikuplja, ne pohranjuje i ne obrađuje vaše podatke na našim serverima. Svi podaci koje unesete ostaju na vašem uređaju, osim ako ih sami izvezete ili pošaljete putem drugih aplikacija (npr. e-pošte).</p>

#### 2. Koje podatke aplikacija obrađuje
<p align="justify">Promet obrađuje podatke koje vi unesete, uvezete ili generirate u aplikaciji. To može uključivati:</p>
...
po vašem izboru: PIN za sigurnosnu kopiju, koji može biti pohranjen lokalno u aplikaciji.</p>

##### 2.3. Podaci iz datoteka koje odaberete
<p align="justify">sadržaj CSV ili Excel (XLSX) datoteka koje sami odaberete za uvoz;
sadržaj sigurnosnih kopija (ZIP) koje sami odaberete za vraćanje podataka.</p>

##### 2.4. Podaci iz QR koda na računu
<p align="justify">pri skeniranju poreznog QR koda na računu, aplikacija čita QR kod kako bi vam pomogla brže unijeti podatke o računu (npr. datum i iznos). Aplikacija koristi Google ML Kit Code Scanner (Google Play usluge). Skeniranje se odvija putem Googleovog sučelja za skeniranje na vašem uređaju. Promet ne snima fotografije računa niti trajno pohranjuje slike QR koda.</p>

#### 3. Kako se podaci pohranjuju
<p align="justify">Svi gore navedeni podaci pohranjuju se lokalno na vašem uređaju, u privatnoj pohrani aplikacije. Aplikacija nema vlastiti poslužitelj, račun za prijavu ni oblak u kojem bismo držali vaše podatke. Android automatsko sigurnosno kopiranje aplikacije je isključeno za Promet. Vi ste odgovorni za sigurnost svojeg uređaja (zaključavanje zaslona, zaštita od neovlaštenog pristupa).</p>
...
#### 6. Mrežni pristup
<p align="justify">Aplikacija može zatražiti dozvolu za pristup internetu i stanju mreže zbog ovisnosti o Google Play uslugama (npr. ML Kit skener). Promet ne šalje vaše poslovne podatke putem interneta.</p>

#### 7. Kamera
<p align="justify">Promet koristi kameru isključivo za skeniranje poreznog QR koda na računu, putem Google ML Kit Code Scannera. Aplikacija ne vodi videozapis niti pohranjuje fotografije računa.</p>
...
#### 11. Sigurnost
<p align="justify">Primjenjujemo razumne tehničke mjere za zaštitu podataka na uređaju, uključujući: lokalnu pohranu unutar aplikacije, opcionalnu PIN enkripciju sigurnosnih kopija, isključeno Android automatsko sigurnosno kopiranje. Nijedan sustav nije potpuno siguran. Vi ste odgovorni za čuvanje PIN-a sigurnosne kopije i za sigurnost uređaja te e-pošte na koju šaljete arhive.</p>

#### 12. Promjene ove politike
<p align="justify">Možemo povremeno ažurirati ovu Politiku privatnosti. Nova verzija bit će objavljena na istoj adresi s novim datumom stupanja na snagu. Za značajne promjene možemo obavijestiti putem aplikacije ili Play Store opisa.</p>
